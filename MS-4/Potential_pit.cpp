...
// Potential_pit.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPotentialpitApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CPotentialpitApp

CPotentialpitApp::CPotentialpitApp()
{
...
// Единственный объект CPotentialpitApp

CPotentialpitApp theApp;


// Инициализация CPotentialpitApp

BOOL CPotentialpitApp::InitInstance()
{
...
BOOL CPotentialpitApp::ExitInstance()
{
	AfxOleTerm(FALSE);
