...
// Puason.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPuasonApp, CWinApp)
...
// Единственный объект CPuasonApp

CPuasonApp theApp;


// Инициализация CPuasonApp

BOOL CPuasonApp::InitInstance()
{
