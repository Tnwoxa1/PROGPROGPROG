...
// DESS.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDESSApp, CWinApp)
...
// Единственный объект CDESSApp

CDESSApp theApp;


// Инициализация CDESSApp

BOOL CDESSApp::InitInstance()
{
