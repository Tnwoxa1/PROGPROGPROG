...
// Oscillator4.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(COscillator4App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание COscillator4App

COscillator4App::COscillator4App()
{
...
// Единственный объект COscillator4App

COscillator4App theApp;


// Инициализация COscillator4App

BOOL COscillator4App::InitInstance()
{
